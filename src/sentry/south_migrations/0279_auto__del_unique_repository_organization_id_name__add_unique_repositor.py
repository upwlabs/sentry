...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique(u'sentry_repository', ['organization_id', 'name'])

        # Adding unique constraint on 'Repository', fields ['organization_id', 'provider', 'name']
        db.create_unique('sentry_repository', ['organization_id', 'provider', 'name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Repository', fields ['organization_id', 'provider', 'name']
        db.delete_unique('sentry_repository', ['organization_id', 'provider', 'name'])

        # Adding unique constraint on 'Repository', fields ['organization_id', 'name']
        db.create_unique(u'sentry_repository', ['organization_id', 'name'])
    ...
    models = {
        ...
        'sentry.broadcast': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'date_expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 11, 16, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
        ...
        'sentry.repository': {
            'Meta': {'unique_together': "(('organization_id', 'provider', 'name'),)", 'object_name': 'Repository'},
            'config': ('jsonfield.fields.JSONField', [], {'default': '{}'}),
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
        ...
        'sentry.useremail': {
            ...
            'validation_hash': ('django.db.models.fields.CharField', [], {'default': "u'7ScP4rXdynu8baarQTliOiyiGiBvCZoY'", 'max_length': '32'})
        },
        'sentry.useroption': {
